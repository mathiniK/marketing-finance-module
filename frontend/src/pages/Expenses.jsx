...
const EXPENSE_CATEGORIES = ['salary', 'subscription', 'marketing', 'utilities', 'other'];
...
const Expenses = () => {
  ...
  const fetchSummary = async () => {
    try {
      const response = await transactionAPI.getExpenseSummary();
  ...
  if (loading) return <LoadingSpinner message="Loading expense data..." />;
  if (error) return <ErrorAlert error={error} title="Failed to load expense data" />;
    ...
    <Box>
      ...
      <Box sx={{ 
        ...
        <Button
          ...
          sx={{ bgcolor: '#f44336', '&:hover': { bgcolor: '#d32f2f' }, width: { xs: '100%', sm: 'auto' } }}
        >
          Add Expense
        </Button>
      </Box>
                  ...
                  <TableRow>
                    <TableCell colSpan={6} align="center">
                      <Typography color="text.secondary" sx={{ py: 3 }}>
                        No expense transactions found. Add your first entry!
                      </Typography>
                    </TableCell>
                  </TableRow>
                ) : (
